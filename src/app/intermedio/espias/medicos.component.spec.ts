...
describe( 'MedicosComponent', () => {
  ...
  it('Init: Debe de cargar los médicos', () => {
    ...
    // cuando llama esa funcion haces otra llamada falsa
  ...
  it( 'Debe de llamar al servidor para agregar un médico', () => {
    ...
    // comprobar que ha sido llamado
    expect(espia).toHaveBeenCalled();
  });

  it('Debe de agregar u nuevo medico al arreglo de médicos', () => {
  ...
  it('Debe de llamar al servidor para borrar un médico', () => {
    // activa el true del confirm directamente
